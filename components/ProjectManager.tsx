    ...
    <div className="bg-white rounded-xl shadow border border-gray-100 overflow-hidden">
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent border-gray-100">
              ...
              <TableHead className="text-right pr-6 text-xs font-medium text-gray-500 uppercase tracking-wider">
                操作
              </TableHead>
            </TableRow>
          </TableHeader>
      ...
      <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 bg-gray-50/30">
        <div className="text-sm text-gray-500">
          每页行{' '}
          <span className="font-medium text-gray-900 bg-gray-100 px-2 py-1 rounded mx-1">
            10
          </span>{' '}
          {(pagination.page - 1) * 10 + 1}-
          {Math.min(pagination.page * 10, pagination.total)} 共{' '}
          {pagination.total}
        </div>
